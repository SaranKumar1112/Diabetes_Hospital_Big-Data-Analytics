...
Analysis of the [UCI Diabetes 130-US Hospitals dataset](https://archive.ics.uci.edu/dataset/296/diabetes+130-us+hospitals+for+years+1999-2008) (~101,766 patient records, 1999–2008) covering hospital stay duration, readmission prediction, and OLAP reporting.

**Key analyses:** descriptive statistics, outlier detection, correlation heatmaps, multinomial logistic regression (MNLogit), logistic regression with class balancing, Gaussian Naive Bayes, and an interactive Plotly/Dash OLAP dashboard.
...
**Files you must provide** (place in `data/`):
...
**Files generated automatically** (do not need to provide):

| File | Generated by |
|---|---|
| `updated cleaned_diabetic_data_with_Median.csv` | 00 notebook → used by 02 |
| `updated_diabetic_data_encoded.csv` | 02 notebook |
| `Tas_diabetic_data_encoded.csv` | 03 notebook |

Run `00_data_preparation.ipynb` first before opening notebook 02.
